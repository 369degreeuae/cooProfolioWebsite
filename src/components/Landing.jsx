...
const Landing = ({id}) => {
  return (
    ...
    <h2 className="text-4xl font-bold leading-7 text-gray-300 sm:text-5xl sm:truncate animate-fadeIn">
      Hello, I am
    </h2>
    <h1 className="mt-2 text-6xl font-extrabold text-gray-50 sm:text-7xl animate-slideInRight">
      Lakshmy Santhosh
    </h1>
    <p className="mt-3 text-xl text-gray-100 animate-fadeInDelay">
     <a href="https://www.369startup.com/"> Coo & General Manager - 369degree Group</a>
    </p>
    <p className="mt-5 text-lg text-center text-gray-400 max-w-3xl mx-auto animate-fadeInLongDelay">
    ...
    <div className="mt-8 flex flex-wrap gap-4 justify-center">
      <a href="#timeline" className="px-3 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900">
        <button className="px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-700 hover:bg-blue-600">
          Learn More About Me
        </button>
      </a>
      <a href="#getintouchcontact" className="px-3 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900">
        <button className="px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-slate-200 hover:bg-gray-50">
          Get In Touch
        </button>
      </a>
    </div>
  ...
  <div className="mt-5 flex lg:mt-0 lg:ml-4 ml-20">
  ...
  {[
    ...
    <div key={index} className="col-span-1 flex flex-col items-center text-gray-300 bg-slate p-4">
      <img
